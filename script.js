...
$(document).ready(function() {
	...
	// Index Page parallax and fade on scroll start //
	...
	// Index Page parallax and fade on scroll end //


	// Index Page Animations for the different pages Start//
	(function() {
        setTimeout(init, 0);
        function init() {
	...
	!(function (e) {
		...
		(n.prototype.options = {
		  ...
		  (n.prototype._getTransformSettings = function (e) {
			...
			return { val: t, origin: { initial: i, halfway: n } };
		  }),
		  (n.prototype.reveal = function (e) {
			...
			(this.revealer.style.WebkitTransform = this.revealer.style.transform =
			  ...
			  (this.revealer.style.WebkitTransformOrigin = this.revealer.style.transformOrigin =
				l.origin.initial),
			  (this.revealer.style.backgroundColor = e.bgcolor || r),
				...
				complete: function () {
				  (c.isAnimating = !1),
					"function" == typeof e.onComplete &&
					  e.onComplete(c.content, c.revealer);
				}
			  },
			  v = {
				delay: e.delay || n,
				complete: function () {
				  (c.revealer.style.WebkitTransformOrigin = c.revealer.style.transformOrigin =
					l.origin.halfway),
					"function" == typeof e.onCover &&
					  e.onCover(c.content, c.revealer),
					anime(h);
				}
			  };
			(v.targets = h.targets = this.revealer),
			  (v.duration = h.duration = e.duration || t),
			  (v.easing = h.easing = e.easing || i);
			var f = e.coverArea || a;
			"lr" === s || "rl" === s
			  ? ((v.scaleX = [0, 1]), (h.scaleX = [1, f / 100]))
			  : ((v.scaleY = [0, 1]), (h.scaleY = [1, f / 100])),
			  "function" == typeof e.onStart && e.onStart(c.content, c.revealer),
			  anime(v);
		  }),
		  (e.RevealFx = n);
	  })(window);
